...
std::this_thread::sleep_for(4000ms); // Sleep for 100 milliseconds
        ...
        std::cout << "WARNING THE FDA HAS ISSUED THIS PROGRAM WILL EXPLODE THE UNIVERSE IF YOU ARE STILL ON IT. WARNING,,WARNING!!\n";
        std::cout << "DO NOT PRESIST DO NOT PRESIST!\n";
         ...
         std::cin >> code;
         if (code == 8501) {
             std::cout << "HAHAHHHBJB YYOOU FAIIOLLLED BBYE BYEEE HAHAHAHHAHAHHAHAHAH@!!!\n";
             using namespace std::chrono_literals;
std::this_thread::sleep_for(4000ms); // Sleep for 100 milliseconds
...
void braden() {
    ...
    std::cout << "Loading.....\n";
    std::cout << "This is not currently working it may be because it is not finished\n";
}
void AI_v1() {
    std::cout << "Hello and welcome to AI v1.0...\n"; 
     std::this_thread::sleep_for(std::chrono::seconds(3));
    std::cout << "WARNING THIS PROGRAM IS IN THE BETA DEVELOPMENT SO BE AWARE THAT THINGS MIGHT BREAK.....\n";
     std::this_thread::sleep_for(std::chrono::seconds(5));
...
void jason() {
    ...
    std::string inpu53;
    std::cin >> inpu53;
    if (inpu53 == "Yes" || inpu53 == "yes" || inpu53 == "y" || inpu53 == "Y" || inpu53 == "Sure" || inpu53 == "sure") {
        std::cout << "Ok then lets continue\n";
        std::this_thread::sleep_for(std::chrono::seconds(2));
        std::cout << "Do you like the color blue? Yes or no\n";
        std::string inpu54;
        std::cin >> inpu54;
        if (inpu54 == "Yes" || inpu54 == "yes" || inpu54 == "y" || inpu54 == "Y" || inpu54 == "Sure" || inpu54 == "sure") {
...
std::this_thread::sleep_for(4000ms); // Sleep for 100 milliseconds
    ...
    std::cout << "       4. Tyler's Program\n";
    std::cout << "       5. Braden's crazy program\n";
    std::cout << "       6. AI V1.0\n";
    std::cout << "       7. The error\n";
    std::cout << "       8. ??????\n";
    std::cout << "       9. Jason's Crazy Program\n";
